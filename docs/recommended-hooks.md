# stn-skills v5.0.0 Hook Enforcement

stn-skills v5.0.0 ships with 6 built-in hooks that provide hardware-level pipeline enforcement. Hooks execute outside the LLM's reasoning chain — Claude cannot rationalize past them.
